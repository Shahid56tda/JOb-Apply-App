...
import com.example.applyononeclickjob.databinding.FragmentRec22Binding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*

class Rec22Fragment : Fragment() {
    lateinit var binding: FragmentRec22Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentRec22Binding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.title = "All Job hiring persons"
        ...
        if (currentUser != null) {
            databaseReference = FirebaseDatabase.getInstance().getReference("hiring persons")
